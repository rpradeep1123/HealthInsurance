...
(function($) {
	...
	var wpt_Carousels_ver1 = function(_class){
		var _get_class = $(_class);
		if(_get_class.length === 0) return;
		_get_class.each(function() {
			if ( $().owlCarousel ){
				$(this).find('.owl-carousel-ver1').owlCarousel({
					loop:true,
					autoplay: true,
					autoplayTimeout:3000,
					margin:0,
					...
					autoplayHoverPause:true,
					dots:false,
					items:parseInt($(this).find('.owl-carousel-ver1').data('columns')),
					responsive:{
						0:{
							items:1,
						},
	...
	var wpt_Carousels_ver2 = function(_class){
		var _get_class = $(_class);
		if(_get_class.length === 0) return;
		_get_class.each(function() {
			if ( $().owlCarousel ){
				$(this).find('.owl-carousel-ver2').owlCarousel({
					loop:true,
					autoplay:true,
					...
					autoplayHoverPause:true,
					dots:false,
					items:parseInt($(this).find('.owl-carousel-ver2').data('columns')),
					responsive:{
						0:{
							items:1,
						},
	...
	var wpt_Carousels_ver3 = function(_class){
		var _get_class = $(_class);
		if(_get_class.length === 0) return;
		_get_class.each(function() {
			if ( $().owlCarousel ){
				$('.owl-carousel-ver3').owlCarousel({
					...
					autoplayHoverPause:true,
					dots:false,
					items:parseInt($(this).find('.owl-carousel-ver3').data('columns')),
					responsive:{
						0:{
							items:1,
						},
	...
	var wpt_Carousels_ver4 = function(_class){
		var _get_class = $(_class);
		if(_get_class.length === 0) return;
		_get_class.each(function() {
			if ( $().owlCarousel ){
				$('.top-deals').owlCarousel({
					...
					autoplayHoverPause:true,
					dots:true,
					item:parseInt($(this).find('.top-deals').data('columns')),
					responsive:{
						0:{
							items:1,
							dots: false,
						...
						1200:{
							items:parseInt($(this).find('.top-deals').data('columns')),
						}
					}
				});
			};
	...
	var wpt_Carousels_ver5 = function(_class){
		var _get_class = $(_class);
		if(_get_class.length === 0) return;
		_get_class.each(function() {
			if ( $().owlCarousel ){
				$('.tickets-slide').owlCarousel({
					loop:true,
					autoplay:true,
					autoplayTimeout:3000,
					margin:18,
					...
					autoplayHoverPause:true,
					dots:true,
					items:parseInt($(this).find('.tickets-slide').data('columns')),
					responsive:{
						0:{
							items:1,
							dots: false,
	...
	var wpt_Carousels_ver6 = function(_class){
		var _get_class = $(_class);
		if(_get_class.length === 0) return;
		_get_class.each(function() {
			if ( $().owlCarousel ){
				$('.testimonial-slide').owlCarousel({
					...
					autoplayHoverPause:true,
					dots:true,
					items:parseInt($(this).find('.testimonial-slide').data('columns')),
					responsive:{
						0:{
							items:1,
							dots: false,
	...
	var wpt_Carousels_ver7 = function(_class){
		var _get_class = $(_class);
		if(_get_class.length === 0) return;
		_get_class.each(function() {
			if ( $().owlCarousel ){
				$('.timeline').owlCarousel({
					...
					autoplayHoverPause:true,
					dots:false,
					items:parseInt($(this).find('.timeline').data('columns')),
					responsive:{
						0:{
							items:2,
						},
	...
	var wpt_Carousel = function(_class){
		var _get_class = $(_class);
		if(_get_class.length === 0) return;
		_get_class.each(function() {
			if ( $().owlCarousel ){
    ...
    var wpt_DateTimePicker = function() {
    	if ( $().datetimepicker ) {  
	...
	$( document ).ready( function() {
		...
		wpt_Carousels_ver1('.partner-area');
		wpt_Carousels_ver2('.related-post');
		wpt_Carousels_ver3('.about-page .content-about');
		wpt_Carousels_ver4('.top-deal-area');
		wpt_Carousels_ver5('.tickets-area');
		wpt_Carousels_ver6('.testimonial-area');
		wpt_Carousels_ver7('.about-history');
		wpt_GoogleMap();
		wpt_DateTimePicker();
		wpt_Tab_Cruises();
		wpt_Tab_Flight();
